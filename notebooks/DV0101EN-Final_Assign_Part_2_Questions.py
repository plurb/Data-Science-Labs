...
data = pd.read_csv(
    'https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBMDeveloperSkillsNetwork-DV0101EN'
...
year_list = [i for i in range(1980, 2024, 1)]  # List of years

# Create the layout of the app
app.layout = html.Div([
    # TASK 2.1 Add title to the dashboard
    html.H1("Automobile Sales Statistics Dashboard",
            style={"textAlign": "justify", "color": "#503D36", "font-size": 26}),  # May include style for title
